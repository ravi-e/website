...
<div class="status-grid">
  <div class="surface status-card">
    ...
    <div class="status-value">Senior Technical Writer</div>
  </div>
  <div class="surface status-card">
    <div class="status-label">Job Search</div>
    <div class="status-value">Open to Opportunities</div>
  </div>
  <div class="surface status-card">
    <div class="status-label">Relocation</div>
    <div class="status-value">Open to Relocating</div>
  </div>
</div>

<div class="profile-frame">
  <img src="/assets/ravi.jpg" alt="Ravi Esakkiappan">
</div>
...
I am currently exploring opportunities for technical writing roles where I can contribute to innovative technical communication strategies.
